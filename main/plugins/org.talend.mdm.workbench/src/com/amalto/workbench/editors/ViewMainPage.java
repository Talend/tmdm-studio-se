        ...
        combox_policy.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (toSelectXPath) {
                    ...
                    XpathSelectDialog2 dlg = new XpathSelectDialog2(getEditorSite().getShell(), null, Messages.ViewMainPage_titleSelectField, getSite(),
                            false, modelName, false, new SortFieldSelectionFilter());
